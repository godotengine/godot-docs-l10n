...
Calcola il determinante di un :ref:`Transform3D<class_Transform3D>` all'interno del grafico di shader visivo.
...
Tradotto in ``determinante(x)`` nel linguaggio shader.
