...
Questo metodo è più veloce di :ref:`distance_to()<class_Vector2_method_distance_to>`, quindi è preferibile se è necessario confrontare vettori o se è necessaria la distanza al quadrato per qualche formula.
