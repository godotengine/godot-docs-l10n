...
Questo importa shader GLSL nativi come risorse :ref:`RDShaderFile<class_RDShaderFile>`, per l'uso con operazioni in :ref:`RenderingDevice<class_RenderingDevice>` di basso livello. Questo importatore *non* gestisce i file ``.gdshader``.
