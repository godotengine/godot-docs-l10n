...
Nodo di visual shader per randomizzare i valori delle particelle.
...
Il nodo di randomizzazione emetterà valori pseudo-casuali del tipo fornito in base ai valori minimi e massimi specificati.
...
Rappresenta la dimensione dell'enumerazione :ref:`OpType<enum_VisualShaderNodeParticleRandomness_OpType>`.
