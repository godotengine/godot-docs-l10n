...
Restituisce la trasformazione per posizionare il nostro poligono per l'entità all'indice ``index``.
...
Restituisce i vertici del poligono per l'entità all'indice ``index``.
