...
Implementazione per gestire la logica di tracciamento dei piani sulle entità spaziali.
...
Questa classe gestisce l'estensione OpenXR per il tracciamento dei piani sulle entità spaziali.
