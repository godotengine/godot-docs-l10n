...
**Eredita:** :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` **<** :ref:`Object<class_Object>`

Fornisce metodi virtuali che possono essere sovrascritti per creare implementazioni di :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` personalizzate.
...
Questa classe estende :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` fornendo ulteriori metodi virtuali che possono essere sovrascritti. Quando questi metodi sono sovrascritti, saranno chiamati al posto dei metodi interni del server di fisica.

Progettato per l'uso con GDExtension per creare implementazioni personalizzate di :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.add_constant_central_force()<class_PhysicsDirectBodyState2D_method_add_constant_central_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.add_constant_force()<class_PhysicsDirectBodyState2D_method_add_constant_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.add_constant_torque()<class_PhysicsDirectBodyState2D_method_add_constant_torque>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_central_force()<class_PhysicsDirectBodyState2D_method_apply_central_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_central_impulse()<class_PhysicsDirectBodyState2D_method_apply_central_impulse>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_force()<class_PhysicsDirectBodyState2D_method_apply_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_impulse()<class_PhysicsDirectBodyState2D_method_apply_impulse>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_torque()<class_PhysicsDirectBodyState2D_method_apply_torque>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.apply_torque_impulse()<class_PhysicsDirectBodyState2D_method_apply_torque_impulse>`.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.angular_velocity<class_PhysicsDirectBodyState2D_property_angular_velocity>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.center_of_mass<class_PhysicsDirectBodyState2D_property_center_of_mass>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.center_of_mass_local<class_PhysicsDirectBodyState2D_property_center_of_mass_local>` e del suo rispettivo getter.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_constant_force()<class_PhysicsDirectBodyState2D_method_get_constant_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_constant_torque()<class_PhysicsDirectBodyState2D_method_get_constant_torque>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider()<class_PhysicsDirectBodyState2D_method_get_contact_collider>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider_id()<class_PhysicsDirectBodyState2D_method_get_contact_collider_id>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider_object()<class_PhysicsDirectBodyState2D_method_get_contact_collider_object>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider_position()<class_PhysicsDirectBodyState2D_method_get_contact_collider_position>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider_shape()<class_PhysicsDirectBodyState2D_method_get_contact_collider_shape>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_collider_velocity_at_position()<class_PhysicsDirectBodyState2D_method_get_contact_collider_velocity_at_position>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_count()<class_PhysicsDirectBodyState2D_method_get_contact_count>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_impulse()<class_PhysicsDirectBodyState2D_method_get_contact_impulse>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_local_normal()<class_PhysicsDirectBodyState2D_method_get_contact_local_normal>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_local_position()<class_PhysicsDirectBodyState2D_method_get_contact_local_position>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_local_shape()<class_PhysicsDirectBodyState2D_method_get_contact_local_shape>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_contact_local_velocity_at_position()<class_PhysicsDirectBodyState2D_method_get_contact_local_velocity_at_position>`.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.inverse_inertia<class_PhysicsDirectBodyState2D_property_inverse_inertia>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.inverse_mass<class_PhysicsDirectBodyState2D_property_inverse_mass>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.linear_velocity<class_PhysicsDirectBodyState2D_property_linear_velocity>` e del suo rispettivo getter.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_space_state()<class_PhysicsDirectBodyState2D_method_get_space_state>`.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.step<class_PhysicsDirectBodyState2D_property_step>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.total_angular_damp<class_PhysicsDirectBodyState2D_property_total_angular_damp>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.total_gravity<class_PhysicsDirectBodyState2D_property_total_gravity>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.total_linear_damp<class_PhysicsDirectBodyState2D_property_total_linear_damp>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.transform<class_PhysicsDirectBodyState2D_property_transform>` e del suo rispettivo getter.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.get_velocity_at_local_position()<class_PhysicsDirectBodyState2D_method_get_velocity_at_local_position>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.integrate_forces()<class_PhysicsDirectBodyState2D_method_integrate_forces>`.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.sleeping<class_PhysicsDirectBodyState2D_property_sleeping>` e del suo rispettivo getter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.angular_velocity<class_PhysicsDirectBodyState2D_property_angular_velocity>` e del suo rispettivo setter.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.set_constant_force()<class_PhysicsDirectBodyState2D_method_set_constant_force>`.
...
Versione sovrascrivibile di :ref:`PhysicsDirectBodyState2D.set_constant_torque()<class_PhysicsDirectBodyState2D_method_set_constant_torque>`.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.linear_velocity<class_PhysicsDirectBodyState2D_property_linear_velocity>` e del suo rispettivo setter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.sleeping<class_PhysicsDirectBodyState2D_property_sleeping>` e del suo rispettivo setter.
...
Implementa per sovrascrivere il comportamento di :ref:`PhysicsDirectBodyState2D.transform<class_PhysicsDirectBodyState2D_property_transform>` e del suo rispettivo setter.
