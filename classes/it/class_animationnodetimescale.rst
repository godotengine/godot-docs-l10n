...
Un nodo di animazione per ridimensionare il tempo usato in :ref:`AnimationTree<class_AnimationTree>`.
...
Consente di scalare la velocità dell'animazione (o invertirla) in qualsiasi :ref:`AnimationNode<class_AnimationNode>` figlio. Impostarlo a ``0.0`` metterà in pausa l'animazione.
