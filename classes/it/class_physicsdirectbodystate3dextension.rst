...
**Eredita:** :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` **<** :ref:`Object<class_Object>`

Fornisce metodi virtuali che possono essere sovrascritti per creare implementazioni di :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` personalizzate.
...
Questa classe estende :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` fornendo ulteriori metodi virtuali che possono essere sovrascritti. Quando questi metodi sono sovrascritti, saranno chiamati al posto dei metodi interni del server di fisica.

Progettato per l'uso con GDExtension per creare implementazioni personalizzate di :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>`.
