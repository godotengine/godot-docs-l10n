...
\ **Nota:** In un contesto booleano, un Transform3D sarà valutato come ``false`` se è uguale a :ref:`IDENTITY<class_Transform3D_constant_IDENTITY>`. Altrimenti, un Transform3D sarà sempre valutato come ``true``.
