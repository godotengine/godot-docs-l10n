...
Questo metodo è più veloce di :ref:`distance_to()<class_Vector3i_method_distance_to>`, quindi è preferibile se è necessario confrontare vettori o se è necessaria la distanza al quadrato per qualche formula.
...
Divide ogni componente del **Vector3i** per il :ref:`float<class_float>` fornito. Restituisce un :ref:`Vector3<class_Vector3>`.
