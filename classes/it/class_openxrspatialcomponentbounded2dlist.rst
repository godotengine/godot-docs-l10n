...
Restituisce il centro della nostro rettangolo limite per l'entità all'indice ``index``.
...
Restituisce le dimensioni del rettangolo limite per l'entità all'indice ``index``.
