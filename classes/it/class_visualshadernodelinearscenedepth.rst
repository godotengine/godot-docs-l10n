...
Un nodo di visual shader che restituisce il valore di profondità del nodo DEPTH_TEXTURE in uno spazio lineare.
...
Questo nodo può essere utilizzato degli shader di tipo fragment.
