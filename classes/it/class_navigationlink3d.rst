...
Un collegamento tra due posizioni sui :ref:`NavigationRegion3D<class_NavigationRegion3D>` attraverso cui gli agenti possono essere indirizzati.
...
Un collegamento tra due posizioni sui :ref:`NavigationRegion3D<class_NavigationRegion3D>` attraverso cui gli agenti possono essere indirizzati. Queste posizioni possono essere sullo stesso :ref:`NavigationRegion3D<class_NavigationRegion3D>` o su due diversi. I collegamenti sono utili per esprimere metodi di navigazione diversi dal viaggiare lungo la superficie del poligono di navigazione, come zipline, teletrasporti o spazi vuoti che possono essere saltati.
...
Se questo collegamento può essere percorso in entrambe le direzioni o solo da :ref:`start_position<class_NavigationLink3D_property_start_position>` a :ref:`end_position<class_NavigationLink3D_property_end_position>`.
...
Se questo collegamento è attualmente attivo. Se ``false``, :ref:`NavigationServer3D.map_get_path()<class_NavigationServer3D_method_map_get_path>` ignorerà questo collegamento.
...
La distanza in cui sarà effettuata la ricerca del collegamento è controllata da :ref:`NavigationServer3D.map_set_link_connection_radius()<class_NavigationServer3D_method_map_set_link_connection_radius>`.
...
Quando la ricerca del percorso entra in questo collegamento da un'altra mesh di navigazione della regione, il valore :ref:`enter_cost<class_NavigationLink3D_property_enter_cost>` è aggiunto alla distanza del percorso per determinare il percorso più breve.
...
Un campo di bit che determina tutti gli strati di navigazione a cui appartiene il collegamento. Questi strati di navigazione saranno controllati quando si richiede un percorso con :ref:`NavigationServer3D.map_get_path()<class_NavigationServer3D_method_map_get_path>`.
...
Quando la ricerca del percorso si muove lungo il collegamento, la distanza percorsa è moltiplicata per :ref:`travel_cost<class_NavigationLink3D_property_travel_cost>` per determinare il percorso più breve.
...
Restituisce la posizione :ref:`end_position<class_NavigationLink3D_property_end_position>` relativa al collegamento in coordinate globali.
...
Restituisce la posizione :ref:`start_position<class_NavigationLink3D_property_start_position>` relativa al collegamento in coordinate globali.
...
Restituisce se lo strato specificato della maschera di bit :ref:`navigation_layers<class_NavigationLink3D_property_navigation_layers>` è abilitato o meno, fornito un ``layer_number`` tra 1 e 32.
...
Restituisce il :ref:`RID<class_RID>` di questo collegamento sul :ref:`NavigationServer3D<class_NavigationServer3D>`.
...
Imposta la posizione :ref:`end_position<class_NavigationLink3D_property_end_position>` relativa al collegamento da una posizione ``position`` in coordinate globali.
...
Imposta la posizione :ref:`start_position<class_NavigationLink3D_property_start_position>` relativa al collegamento da una posizione ``position`` in coordinate globali.
...
In base al ``value``, abilita o disabilita lo strato specificato nella maschera di bit :ref:`navigation_layers<class_NavigationLink3D_property_navigation_layers>`, fornito un ``layer_number`` compreso tra 1 e 32.
