...
**Eredita:** :ref:`PhysicsServer3D<class_PhysicsServer3D>` **<** :ref:`Object<class_Object>`

Fornisce metodi virtuali che possono essere sovrascritti per creare implementazioni di :ref:`PhysicsServer3D<class_PhysicsServer3D>` personalizzate.
...
Questa classe estende :ref:`PhysicsServer3D<class_PhysicsServer3D>` fornendo metodi virtuali aggiuntivi che possono essere sovrascritti. Quando questi metodi sono sovrascritti, saranno chiamati al posto dei metodi interni del server di fisica.

Progettato per l'uso con GDExtension per creare implementazioni personalizzate di :ref:`PhysicsServer3D<class_PhysicsServer3D>`.
