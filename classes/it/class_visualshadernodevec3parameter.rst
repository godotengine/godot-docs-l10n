...
Un parametro di tipo :ref:`Vector3<class_Vector3>` da utilizzare all'interno del grafico di visual shader.
...
Tradotto come ``uniform vec4`` nel linguaggio di shader.
...
Abilita l'uso di :ref:`default_value<class_VisualShaderNodeVec3Parameter_property_default_value>`.
