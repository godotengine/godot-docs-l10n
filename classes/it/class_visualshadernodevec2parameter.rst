...
Un parametro di tipo :ref:`Vector2<class_Vector2>` da utilizzare all'interno del grafico di visual shader.
...
Tradotto come ``uniform vec2`` nel linguaggio di shader.
...
Abilita l'uso di :ref:`default_value<class_VisualShaderNodeVec2Parameter_property_default_value>`.
