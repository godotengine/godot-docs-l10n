...
**Eredita:** :ref:`PhysicsDirectSpaceState2D<class_PhysicsDirectSpaceState2D>` **<** :ref:`Object<class_Object>`

Fornisce metodi virtuali che possono essere sovrascritti per creare implementazioni di :ref:`PhysicsDirectSpaceState2D<class_PhysicsDirectSpaceState2D>` personalizzate.
...
Questa classe estende :ref:`PhysicsDirectSpaceState2D<class_PhysicsDirectSpaceState2D>` fornendo ulteriori metodi virtuali che possono essere sovrascritti. Quando questi metodi sono sovrascritti, saranno chiamati al posto dei metodi interni del server di fisica.

Progettato per l'uso con GDExtension per creare implementazioni personalizzate di :ref:`PhysicsDirectSpaceState2D<class_PhysicsDirectSpaceState2D>`.
