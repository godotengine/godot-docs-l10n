...
Una costante :ref:`Color<class_Color>` da utilizzare all'interno del grafico di shader visivo.
...
Ha due porte di uscita che rappresentano i canali RGB e alfa di :ref:`Color<class_Color>`.

Tradotto in ``vec3 rgb`` e ``float alpha`` nel linguaggio shader.
...
Una costante :ref:`Color<class_Color>` che rappresenta uno stato di questo nodo.
