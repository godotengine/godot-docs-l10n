...
L'array del percorso risultante dalla ricerca di navigazione. Tutte le posizioni dell'array del percorso sono in coordinate globali. Senza parametri di ricerca personalizzati, questo è lo stesso percorso restituito da :ref:`NavigationServer2D.map_get_path()<class_NavigationServer2D_method_map_get_path>`.
