...
Esegue una ricerca di texture normale con SDF (signed distance field) all'interno del grafico di visual shader.
...
Tradotto come ``texture_sdf_normal(sdf_pos)`` nel linguaggio di shader.
