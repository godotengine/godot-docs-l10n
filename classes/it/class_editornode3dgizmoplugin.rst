...
Sovrascrivi questo metodo per definire se i gizmo dovrebbero commettersi quando la posizione finale della maniglia è la stessa di quella iniziale. Restituisce ``false`` se non sovrascritto.
