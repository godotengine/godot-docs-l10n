...
Un parametro di vettore 4D da utilizzare all'interno del grafico di visual shader.
...
Abilita l'uso di :ref:`default_value<class_VisualShaderNodeVec4Parameter_property_default_value>`.
