...
Un livello di composizione OpenXR che è renderizzato come una sezione interna di un cilindro.
...
Un livello di composizione OpenXR che consente di renderizzare una :ref:`SubViewport<class_SubViewport>` su una sezione interna di un cilindro.
...
Il rapporto di aspetto della sezione. Utilizzato per impostare l'altezza relativa alla larghezza.
...
L'angolo centrale del cilindro. Utilizzato per impostare la larghezza.
