...
Restituisce ``true`` se il thread da cui è stato chiamato questo metodo è il thread principale.

\ **Nota:** Questo è un metodo statico e non è associato con un oggetto **Thread** specifico.
