...
Aggiunge un effetto audio di manipolazione stereo a un bus audio.

Controlla il guadagno dei canali laterali e amplia l'immagine stereo.
...
Regola il guadagno dei canali sinistro e destro, e converte i suoni mono in stereo tramite uno sfasamento.
...
Guadagno dei canali laterali, se esistono. Un valore pari a 0 convertirà un segnale stereo in mono. Il valore può variare da 0 a 4.
...
Amplia la scena sonora tramite sfasamento, in combinazione con :ref:`time_pullout_ms<class_AudioEffectStereoEnhance_property_time_pullout_ms>`. Sposta semplicemente l'audio sul canale sinistro se :ref:`time_pullout_ms<class_AudioEffectStereoEnhance_property_time_pullout_ms>` è 0. Il valore può variare da 0 a 1.
...
Amplia la scena sonora tramite sfasamento, in combinazione con :ref:`surround<class_AudioEffectStereoEnhance_property_surround>`. Ritarda solo il canale destro se :ref:`surround<class_AudioEffectStereoEnhance_property_surround>` è 0. Il valore è in millisecondi, e può variare da 0 a 50.
