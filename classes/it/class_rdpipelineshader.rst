...
Shader di pipeline (utilizzato da :ref:`RenderingDevice<class_RenderingDevice>`).
...
Risorsa shader. La fase richiesta è selezionata dalla pipeline.
...
Costanti di specializzazione applicate alla fase selezionata dello shader al momento della creazione della pipeline.
