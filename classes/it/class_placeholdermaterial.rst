...
Classe segnaposto per un materiale.
...
Questa classe è utilizzata quando si carica un progetto che utilizza una sottoclasse di :ref:`Material<class_Material>` in 2 condizioni:
