...
Specifica il tipo della texture se :ref:`source<class_VisualShaderNodeTexture_property_source>` è impostato su :ref:`SOURCE_TEXTURE<class_VisualShaderNodeTexture_constant_SOURCE_TEXTURE>`.
