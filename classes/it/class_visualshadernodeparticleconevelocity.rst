...
Questo nodo può essere utilizzato nella fase di "inizio" dello shader di particelle. Definisce la velocità iniziale delle particelle, facendoli muovere in forma di cono a partire dal centro, con una data propagazione.
