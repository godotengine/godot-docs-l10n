...
Una costante di tipo :ref:`Vector2<class_Vector2>` da utilizzare all'interno del grafico di visual shader.
...
Una costante di tipo :ref:`Vector2<class_Vector2>`, che può essere utilizzata come nodo in ingresso.
...
Una costante di tipo :ref:`Vector2<class_Vector2>` che rappresenta lo stato di questo nodo.
