...
Oggetto per memorizzare i dati risultanti di una richiesta sui marcatori quando si chiama :ref:`OpenXRSpatialEntityExtension.query_snapshot()<class_OpenXRSpatialEntityExtension_method_query_snapshot>`.
