...
Classe segnaposto per una mesh.
...
Questa classe è utilizzata quando si carica un progetto che utilizza una sottoclasse di :ref:`Mesh<class_Mesh>` in 2 condizioni:
...
Il più piccolo :ref:`AABB<class_AABB>` che racchiude questa mesh nello spazio locale.
