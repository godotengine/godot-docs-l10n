...
Descrive il risultato del movimento e della collisione da :ref:`PhysicsServer2D.body_test_motion()<class_PhysicsServer2D_method_body_test_motion>`.
...
Restituisce l':ref:`Object<class_Object>` associato al corpo in collisione, se si è verificata una collisione.
...
Restituisce l'ID univoco di istanza dell':ref:`Object<class_Object>` associato al corpo in collisione, se si è verificata una collisione. Vedi :ref:`Object.get_instance_id()<class_Object_method_get_instance_id>`.
...
Restituisce il :ref:`RID<class_RID>` del corpo in collisione utilizzato dal :ref:`PhysicsServer2D<class_PhysicsServer2D>`, se si è verificata una collisione.
...
Restituisce l'indice della forma del corpo in collisione, se si è verificata una collisione. Vedi :ref:`CollisionObject2D<class_CollisionObject2D>`.
