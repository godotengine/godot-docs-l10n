...
Una :ref:`Cubemap<class_Cubemap>` senza dati di immagine.
...
Questa classe sostituisce una :ref:`Cubemap<class_Cubemap>` o una classe derivata da :ref:`Cubemap<class_Cubemap>` in 2 condizioni:
...
- Quando manca la classe derivata da :ref:`Cubemap<class_Cubemap>`, ad esempio quando si utilizza una versione diversa del motore.
