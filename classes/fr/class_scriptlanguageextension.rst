...
**Hérite de :** :ref:`ScriptLanguage<class_ScriptLanguage>` **<** :ref:`Object<class_Object>`
...
**Obsolète :** Cette constante peut être changée ou retirée dans de futures versions.
...
Renvoie la ligne où la fonction est définie dans le code, ou ``-1`` si la fonction n'est pas présente.
