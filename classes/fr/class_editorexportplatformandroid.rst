...
- :doc:`Exportation pour Android <../tutorials/export/exporting_for_android>`

- :doc:`Compilations Gradle pour Android <../tutorials/export/android_gradle_build>`

- :doc:`Index de la documentation sur les plugins Android <../tutorials/platform/index>`
...
Permet aux application d’appeler des AccountAuthentificators. Voir `ACCOUNT_MANAGER <https://developer.android.com/reference/android/Manifest.permission#ACCOUNT_MANAGER>`__.
...
Autorise l'accès à la lampe-torche.
...
**Obsolète :** Deprecated in API level 21.
...
Voir `MASTER_CLEAR <https://developer.android.com/reference/android/Manifest.permission#MASTER_CLEAR>`__.
...
**Obsolète :** Deprecated in API level 15.
...
**Obsolète :** Deprecated in API level 29.

Permet à une application de voir le numéro qui est composé pendant un appel sortant avec l'option de rediriger l'appel vers un numéro différent ou d'annuler l'appel dans son ensemble. Voir `PROCESS_OUTGOING_CALLS <https://developer.android.com/reference/android/Manifest.permission#PROCESS_OUTGOING_CALLS>`__.
...
**Obsolète :** Deprecated in API level 33.
...
**Obsolète :** Deprecated in API level 16.
