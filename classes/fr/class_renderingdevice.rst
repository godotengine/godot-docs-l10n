...
- :doc:`Utiliser des shaders de calcul <../tutorials/shaders/compute_shaders>`
...
Représente la taille de l'énumération :ref:`DeviceType<enum_RenderingDevice_DeviceType>`.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_LOGICAL_DEVICE<class_RenderingDevice_constant_DRIVER_RESOURCE_LOGICAL_DEVICE>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_PHYSICAL_DEVICE<class_RenderingDevice_constant_DRIVER_RESOURCE_PHYSICAL_DEVICE>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_TOPMOST_OBJECT<class_RenderingDevice_constant_DRIVER_RESOURCE_TOPMOST_OBJECT>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_COMMAND_QUEUE<class_RenderingDevice_constant_DRIVER_RESOURCE_COMMAND_QUEUE>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_QUEUE_FAMILY<class_RenderingDevice_constant_DRIVER_RESOURCE_QUEUE_FAMILY>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_TEXTURE<class_RenderingDevice_constant_DRIVER_RESOURCE_TEXTURE>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_TEXTURE_VIEW<class_RenderingDevice_constant_DRIVER_RESOURCE_TEXTURE_VIEW>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_TEXTURE_DATA_FORMAT<class_RenderingDevice_constant_DRIVER_RESOURCE_TEXTURE_DATA_FORMAT>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_SAMPLER<class_RenderingDevice_constant_DRIVER_RESOURCE_SAMPLER>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_UNIFORM_SET<class_RenderingDevice_constant_DRIVER_RESOURCE_UNIFORM_SET>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_BUFFER<class_RenderingDevice_constant_DRIVER_RESOURCE_BUFFER>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_COMPUTE_PIPELINE<class_RenderingDevice_constant_DRIVER_RESOURCE_COMPUTE_PIPELINE>` instead.
...
**Obsolète :** Use :ref:`DRIVER_RESOURCE_RENDER_PIPELINE<class_RenderingDevice_constant_DRIVER_RESOURCE_RENDER_PIPELINE>` instead.
...
Représente la taille de l'énumération :ref:`DataFormat<enum_RenderingDevice_DataFormat>`.
...
Tableau de textures unidimensionnelles.
...
Tableau de textures bidimensionnelles.
...
Tableau de textures :ref:`Cubemap<class_Cubemap>`.
...
Représente la taille de l’énumération :ref:`TextureType<enum_RenderingDevice_TextureType>`.
...
Effectue 2 échantillonnages de texture.
...
Effectue 4 échantillonnages de texture.
...
Représente la taille de l’énumération :ref:`TextureSamples<enum_RenderingDevice_TextureSamples>`.
...
La texture peut être échantillonnée.
...
Renvoie la valeur échantillonnée telle quelle.
...
Toujours renvoyer ``0.0`` lors de l’échantillonnage.
...
Toujours renvoyer ``1.0`` lors de l’échantillonnage.
...
Échantillonne le canal du rouge.
...
Échantillonne le canal du vert.
...
Échantillonne le canal du bleu.
...
Représente la taille de l’énumération :ref:`TextureSwizzle<enum_RenderingDevice_TextureSwizzle>`.
...
Tranche de texture 2 dimensionnelle.
...
Tranche de texture 3-dimensionnelle.
...
Échantillonne avec la répétition activée.
...
Représente la taille de l'énumération :ref:`SamplerRepeatMode<enum_RenderingDevice_SamplerRepeatMode>`.
...
Représente la taille de l'énumération :ref:`SamplerBorderColor<enum_RenderingDevice_SamplerBorderColor>`.
...
Représente la taille de l'énumération :ref:`UniformType<enum_RenderingDevice_UniformType>`.
...
Représente la taille de l'énumération :ref:`RenderPrimitive<enum_RenderingDevice_RenderPrimitive>`.
...
Représente la taille de l'énumération :ref:`StencilOperation<enum_RenderingDevice_StencilOperation>`.
...
Représente la taille de l'énumération :ref:`CompareOperator<enum_RenderingDevice_CompareOperator>`.
...
Opération logique Clear (le résultat est toujours ``0``). Voir aussi :ref:`LOGIC_OP_SET<class_RenderingDevice_constant_LOGIC_OP_SET>`.
...
Opération logique AND avec l'opérande de *destination* inversé. Voir aussi :ref:`LOGIC_OP_AND_INVERTED<class_RenderingDevice_constant_LOGIC_OP_AND_INVERTED>`.
...
Copie l'opération logique (garde la valeur *source* telle quelle). Voir aussi :ref:`LOGIC_OP_COPY_INVERTED<class_RenderingDevice_constant_LOGIC_OP_COPY_INVERTED>` et :ref:`LOGIC_OP_NO_OP<class_RenderingDevice_constant_LOGIC_OP_NO_OP>`.
...
Opération logique AND avec l'opérande *source* inversé. Voir aussi :ref:`LOGIC_OP_AND_REVERSE<class_RenderingDevice_constant_LOGIC_OP_AND_REVERSE>`.
...
Opération logique no-op (garde la valeur de *destination* telle qu'elle). Voir aussi :ref:`LOGIC_OP_COPY<class_RenderingDevice_constant_LOGIC_OP_COPY>`.
...
Opération logique exclusif ou (XOR).
...
Opération logique non-OU exclusif (XNOR).
...
Opération logique OR avec l'opérande de *destination* inversé. Voir aussi :ref:`LOGIC_OP_OR_REVERSE<class_RenderingDevice_constant_LOGIC_OP_OR_REVERSE>`.
...
Opération logique NOT (inverse la valeur). Voir aussi :ref:`LOGIC_OP_COPY<class_RenderingDevice_constant_LOGIC_OP_COPY>`.
...
Opération logique OR avec l'opérande *source* inversé. Voir aussi :ref:`LOGIC_OP_OR_REVERSE<class_RenderingDevice_constant_LOGIC_OP_OR_REVERSE>`.
...
Opération logique SET (le résultat est toujours ``1``). Voir aussi :ref:`LOGIC_OP_CLEAR<class_RenderingDevice_constant_LOGIC_OP_CLEAR>`.
...
Représente la taille de l'énumération :ref:`LogicOperation<enum_RenderingDevice_LogicOperation>`.
...
Facteur de mélange ``0.0`` constant.
...
Facteur de mélange constant ``1.0``.
...
Représente la taille de l'énumération :ref:`BlendFactor<enum_RenderingDevice_BlendFactor>`.
...
Représente la taille de l'énumération :ref:`BlendOperation<enum_RenderingDevice_BlendOperation>`.
...
**Obsolète :** Initial actions are solved automatically by RenderingDevice.
...
Efface le buffer de trame entier ou sa région spécifiée.
...
Représente la taille de l'énumération :ref:`InitialAction<enum_RenderingDevice_InitialAction>`.
...
**Obsolète :** Final actions are solved automatically by RenderingDevice.
...
Représente la taille de l'énumération :ref:`FinalAction<enum_RenderingDevice_FinalAction>`.
...
Représente la taille de l'énumération :ref:`ShaderStage<enum_RenderingDevice_ShaderStage>`.
...
Constante de spécialisation de booléen.
...
Constante de spécialisation d'entier.
...
Mémoire prise par des textures.
...
Lors d'un crash GPU en mode développement ou débogage, le message d'erreur de Godot comprendra ``"BLIT_PASS"`` pour un contexte ajouté à quand l'accident s'est produit.
...
**Obsolète :** Barriers are automatically inserted by RenderingDevice.
...
**Obsolète :** Inserting labels no longer applies due to command reordering.
...
Renvoie le nom du type d'objet pour l'index ``type_index``. Cette valeur doit être dans l'intervalle ``[0; get_tracked_object_type_count - 1]``. Si :ref:`get_tracked_object_type_count()<class_RenderingDevice_method_get_tracked_object_type_count>` vaut 0, alors l'argument de type est ignoré et renvoie toujours la même chaîne.

La valeur de renvoi est importante parce qu'elle donne un sens aux types passés à :ref:`get_driver_memory_by_object_type()<class_RenderingDevice_method_get_driver_memory_by_object_type>`, :ref:`get_driver_allocs_by_object_type()<class_RenderingDevice_method_get_driver_allocs_by_object_type>`, :ref:`get_device_memory_by_object_type()<class_RenderingDevice_method_get_device_memory_by_object_type>`, et :ref:`get_device_allocs_by_object_type()<class_RenderingDevice_method_get_device_allocs_by_object_type>`. Exemples de chaînes qu'elle peut renvoyer (non exhaustif) :
...
Ainsi, si par exemple ``get_tracked_object_name(5)`` renvoie "COMMAND_POOL", alors ``get_device_memory_by_object_type(5)`` renvoie les octets utilisés par le GPU pour les pools de commande.

Ceci n'est utilisé que par Vulkan dans les compilations de débogage. Godot doit également être lancé avec l':doc:`argument en ligne de commande <../tutorials/editor/command_line_tutorial>` ``--extra-gpu-memory-tracking``.
...
**Obsolète :** Use :ref:`get_driver_resource()<class_RenderingDevice_method_get_driver_resource>` with :ref:`DRIVER_RESOURCE_TEXTURE<class_RenderingDevice_constant_DRIVER_RESOURCE_TEXTURE>` instead.
