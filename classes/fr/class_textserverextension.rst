...
Renvoie ``true`` si le buffer de texte est configuré pour afficher des codes hexadécimaux à la place des caractères invalides.
...
Définit l'orientation du texte désirée.
