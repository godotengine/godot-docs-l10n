...
- :doc:`Systèmes de contrôle de version <../tutorials/best_practices/version_control_systems>`
...
Renvoie un :ref:`Array<class_Array>` d'éléments :ref:`Dictionary<class_Dictionary>` (voir :ref:`create_status_file()<class_EditorVCSInterface_method_create_status_file>`), contenant chacun les données d'état de chaque fichier modifié dans le dossier du projet.
...
Renvoie un :ref:`Array<class_Array>` de :ref:`String<class_String>`, chacune contient le nom d'un dépôt distant configuré dans le VCS.
