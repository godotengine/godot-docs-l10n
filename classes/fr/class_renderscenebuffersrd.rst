...
**Hérite de :** :ref:`RenderSceneBuffers<class_RenderSceneBuffers>` **<** :ref:`RefCounted<class_RefCounted>` **<** :ref:`Object<class_Object>`
...
Renvoie ``true`` si une texture mise en cache existe pour ce nom.
