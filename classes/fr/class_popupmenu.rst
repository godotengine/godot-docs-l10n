...
Si ``true``, permet de naviguer dans le **PopupMenu** avec des touches alphabétiques.
...
Si ``true``, masque le **PopupMenu** quand une coche ou un bouton radio est sélectionné.
...
Si ``true``, cache le **PopupMenu** lorsqu'un élément est sélectionné.
...
Si ``true``, cache le **PopupMenu** lorsqu'un élément d'état est sélectionné.
...
Pareil que :ref:`add_icon_check_item()<class_PopupMenu_method_add_icon_check_item>`, mais utilise un bouton radio.
...
Pareil que :ref:`add_icon_check_shortcut()<class_PopupMenu_method_add_icon_check_shortcut>`, mais utilise un bouton radio.
...
**Obsolète :** Prefer using :ref:`add_submenu_node_item()<class_PopupMenu_method_add_submenu_node_item>` instead.
...
Renvoie la position de l’élément qui a actuellement le focus. Ou renvoie ``-1`` si aucun n'a le focus.
...
Renvoie les métadonnées de l'élément spécifié, qui peuvent être de n'importe quel type. Vous pouvez les définir avec :ref:`set_item_metadata()<class_PopupMenu_method_set_item_metadata>`, qui fournit un moyen simple d'affecter des données de contexte aux éléments.
...
Renvoie l'état de l'élément à l'``index`` donné.
...
**Obsolète :** Prefer using :ref:`get_item_submenu_node()<class_PopupMenu_method_get_item_submenu_node>` instead.
...
Définit l'état d'un objet multi-états. Voir :ref:`add_multistate_item()<class_PopupMenu_method_add_multistate_item>` pour plus de détails.
...
**Obsolète :** Prefer using :ref:`set_item_submenu_node()<class_PopupMenu_method_set_item_submenu_node>` instead.
...
Cycle vers l'état suivant d'un objet multi-états. Voir :ref:`add_multistate_item()<class_PopupMenu_method_add_multistate_item>` pour plus de détails.
...
La :ref:`Color<class_Color>` par défaut du texte pour les noms des éléments du menu.
...
La :ref:`Color<class_Color>` utilisée pour le texte des éléments désactivés du menu.
...
La :ref:`Color<class_Color>` utilisée pour le texte survolé.
...
L'espace horizontal entre les objets de l'élément.
...
L’espace vertical entre chaque élément de menu.
...
La :ref:`Font<class_Font>` utilisée pour les éléments du menu.
...
La :ref:`Font<class_Font>` utilisée pour le séparateur avec texte.
...
Le :ref:`StyleBox<class_StyleBox>` affiché quand un élément d'un **PopupMenu** est survolé.
...
La :ref:`StyleBox<class_StyleBox>` pour le côté gauche du séparateur avec label. Voir :ref:`add_separator()<class_PopupMenu_method_add_separator>`.
...
La :ref:`StyleBox<class_StyleBox>` pour le côté droit du séparateur avec label. Voir :ref:`add_separator()<class_PopupMenu_method_add_separator>`.
...
Le :ref:`StyleBox<class_StyleBox>` utilisé pour les séparateurs. Voir :ref:`add_separator()<class_PopupMenu_method_add_separator>`.
