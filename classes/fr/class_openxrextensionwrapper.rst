...
Appelée quand il y a un événement OpenXR à traiter. Lors de l'implémentation, renvoyez ``true`` si l'événement a été géré, renvoyez ``false`` autrement.
