...
Si ``true``, vous pouvez connecter les ports avec des types différents, même si la connexion n'était pas explicitement autorisée dans le :ref:`GraphEdit<class_GraphEdit>` parent.
