...
Voir aussi :ref:`ResourceImporterOBJ<class_ResourceImporterOBJ>`, qui est utilisé pour les modèles OBJ qui peuvent être importés comme un :ref:`Mesh<class_Mesh>` indépendant ou une scène.
...
\ **Note :** **ResourceImporterScene** n'est *pas* utilisé pour les :ref:`PackedScene<class_PackedScene>`\ s, comme les fichiers ``.tscn`` et ``.scn``.
