...
Ajoute du support pour une action d'accessibilité personnalisée. ``action_id`` est passé comme un argument au callback de l'action :ref:`ACTION_CUSTOM<class_AccessibilityServer_constant_ACTION_CUSTOM>`.
