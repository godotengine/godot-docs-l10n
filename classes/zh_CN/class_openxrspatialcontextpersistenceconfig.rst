...
获取由 :ref:`add_persistence_context()<class_OpenXRSpatialContextPersistenceConfig_method_add_persistence_context>` 方法接收到的持久化上下文（persistence context）（以 :ref:`RID<class_RID>` 的形式返回）。
