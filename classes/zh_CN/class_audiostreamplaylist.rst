...
一种可以按顺序播放子音频流的音频流。可以通过 :ref:`set_list_stream()<class_AudioStreamPlaylist_method_set_list_stream>` 将音频流添加到播放列表中，且可以使用 :ref:`shuffle<class_AudioStreamPlaylist_property_shuffle>` 进行乱序播放。
