...
向音频总线添加一个 10 段均衡器音频效果。

允许控制 31 Hz 到 16000 Hz 的频率。每个频率可在 -60 dB 到 +24 dB 之间进行调制。
...
另见 :ref:`AudioEffectEQ<class_AudioEffectEQ>`\ 、\ :ref:`AudioEffectEQ6<class_AudioEffectEQ6>`\ 、\ :ref:`AudioEffectEQ21<class_AudioEffectEQ21>`\ 。
