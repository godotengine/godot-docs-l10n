...
与 :ref:`SpringBoneSimulator3D<class_SpringBoneSimulator3D>` 交互的无限延伸的平面碰撞。
...
与 :ref:`SpringBoneSimulator3D<class_SpringBoneSimulator3D>` 交互的无限延伸的平面碰撞，是无穷大的 XZ 平面，+Y 方向为法线。
