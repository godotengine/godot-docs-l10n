...
向音频总线添加一个 6 段均衡器音频效果。

允许控制 32 Hz 到 10000 Hz 的频率。每个频率可在 -60 dB 到 +24 dB 之间进行调制。
...
另见 :ref:`AudioEffectEQ<class_AudioEffectEQ>`\ 、\ :ref:`AudioEffectEQ10<class_AudioEffectEQ10>`\ 、\ :ref:`AudioEffectEQ21<class_AudioEffectEQ21>`\ 。
