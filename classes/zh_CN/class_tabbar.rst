...
按下某个选项卡的关闭按钮时发出，启用 :ref:`close_with_middle_mouse<class_TabBar_property_close_with_middle_mouse>` 时中键点击选项卡也会发出。
...
如果为 ``true``\ ，则鼠标中键点击会发出 :ref:`tab_close_pressed<class_TabBar_signal_tab_close_pressed>` 信号。
