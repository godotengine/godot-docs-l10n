...
用于存储调用 :ref:`OpenXRSpatialEntityExtension.query_snapshot()<class_OpenXRSpatialEntityExtension_method_query_snapshot>` 时查询到的 3D 边界框结果数据的对象。
