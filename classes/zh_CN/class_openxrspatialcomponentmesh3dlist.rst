...
用于存储调用 :ref:`OpenXRSpatialEntityExtension.query_snapshot()<class_OpenXRSpatialEntityExtension_method_query_snapshot>` 时生成的 3D 网格查询结果数据的对象。
