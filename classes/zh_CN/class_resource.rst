...
深度复制该资源，类似于 :ref:`duplicate()<class_Resource_method_duplicate>`\ ``(true)``\ ，但可以进一步控制子资源的处理方式。

\ ``deep_subresources_mode`` 必须是 :ref:`DeepDuplicateMode<enum_Resource_DeepDuplicateMode>` 中的值。
