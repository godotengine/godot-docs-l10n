...
Se puede utilizar un ``type_hint`` opcional para especificar con más detalle el tipo de :ref:`Resource<class_Resource>` que debe manejar el :ref:`ResourceFormatLoader<class_ResourceFormatLoader>`.
