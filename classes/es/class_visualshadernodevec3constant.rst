...
Una constante :ref:`Vector3<class_Vector3>` para ser usada dentro del gráfico shader visual.

Descripción
----------------------

Una constante :ref:`Vector3<class_Vector3>`, que puede ser usada como un nodo de entrada.
...
Una constante :ref:`Vector3<class_Vector3>` que representa el estado de este nodo.
