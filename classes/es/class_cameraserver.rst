...
- **FEED_RGBA_IMAGE** = **0** --- La imagen de la cámara RGBA.

- **FEED_YCBCR_IMAGE** = **0** --- The YCbCr camera image.

- **FEED_Y_IMAGE** = **0** --- La imagen de la cámara del componente Y.

- **FEED_CBCR_IMAGE** = **1** --- La imagen de la cámara del componente CbCr.
