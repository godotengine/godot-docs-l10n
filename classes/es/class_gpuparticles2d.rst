...
\ ``process_time`` define el tiempo que las partículas procesarán mientras la emisión está activa. ``process_time_residual`` define el tiempo que las partículas procesarán con la emisión apagada para la simulación. Cuando se combina con :ref:`speed_scale<class_GPUParticles2D_property_speed_scale>` configurado en ``0.0``, esto es útil para poder buscar una línea temporal del sistema de partículas.
