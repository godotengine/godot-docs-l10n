...
Emitida cuando se llama a :ref:`notify_property_list_changed()<class_Object_method_notify_property_list_changed>`.
...
Las conexiones de one-shot se desconectan después de la emisión.
