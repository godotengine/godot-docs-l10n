...
Botón que hace aparecer un :ref:`ColorPicker<class_ColorPicker>`.
...
Se emite cuando se crea el :ref:`ColorPicker<class_ColorPicker>` (se pulsa el botón por primera vez).
...
Emitido cuando el :ref:`ColorPicker<class_ColorPicker>` está cerrado.
...
Si ``true``, el canal alfa en el :ref:`ColorPicker<class_ColorPicker>` visualizado será visible.
...
El :ref:`Color<class_Color>` del texto predeterminado para el ``ColorPickerButton``.
...
:ref:`Color<class_Color>` del texto utilizado cuando el ``ColorPickerButton`` está desactivado.
...
:ref:`Color<class_Color>` del texto usado cuando el ``ColorPickerButton`` tiene el cursor encima.
...
:ref:`Color<class_Color>` del texto utilizado cuando se pulsa el ``ColorPickerButton``.
...
:ref:`Font<class_Font>` del texto de ``ColorPickerButton``.
...
:ref:`StyleBox<class_StyleBox>` utilizado cuando el ``ColorPickerButton`` está desactivado.
...
:ref:`StyleBox<class_StyleBox>` usado cuando el ``ColorPickerButton`` está enfocado. Se muestra sobre el :ref:`StyleBox<class_StyleBox>` actual, por lo que al usar :ref:`StyleBoxEmpty<class_StyleBoxEmpty>` sólo se desactivará el efecto visual de enfoque.
...
:ref:`StyleBox<class_StyleBox>` usado cuando el ``ColorPickerButton`` tiene el cursor encima.
...
:ref:`StyleBox<class_StyleBox>` por defecto para el ``ColorPickerButton``.
...
:ref:`StyleBox<class_StyleBox>` que se utiliza cuando se pulsa el ``ColorPickerButton``.
