...
- **RADIANCE_SIZE_32** = **0** --- El tamaño de la textura de la radiación es de 32×32 píxeles.

- **RADIANCE_SIZE_64** = **1** --- El tamaño de la textura de la radiación es de 64×64 píxeles.

- **RADIANCE_SIZE_128** = **2** --- El tamaño de la textura del resplandor es de 128×128 píxeles.

- **RADIANCE_SIZE_256** = **3** --- El tamaño de la textura del resplandor es de 256×256 píxeles.

- **RADIANCE_SIZE_512** = **4** --- El tamaño de la textura del resplandor es de 512×512 píxeles.
...
- **RADIANCE_SIZE_MAX** = **7** --- Representa el tamaño del enum :ref:`RadianceSize<enum_Sky_RadianceSize>`.
