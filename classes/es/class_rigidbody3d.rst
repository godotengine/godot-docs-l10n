...
**Heredado por:** :ref:`VehicleBody3D<class_VehicleBody3D>`
...
Modo de congelación cinemática de cuerpos. Similar a :ref:`FREEZE_MODE_STATIC<class_RigidBody3D_constant_FREEZE_MODE_STATIC>`, pero colisiona con otros cuerpos en su trayectoria al moverse. Útil para cuerpos congelados que necesitan ser animados.
...
En este modo, el centro de masa del cuerpo se establece a través de :ref:`center_of_mass<class_RigidBody3D_property_center_of_mass>`. El valor predeterminado es la posición de origen del cuerpo.
...
Define cómo se aplica :ref:`angular_damp<class_RigidBody3D_property_angular_damp>`.
