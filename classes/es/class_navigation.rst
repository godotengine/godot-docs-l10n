...
Nodo de navegación y busqueda de caminos basado en una malla.
...
Define qué dirección es hacia arriba. Por defecto, esto es ``(0, 1, 0)``, que es la dirección "arriba" del mundo.
