...
**Nota:** Esta clase no debe ser instanciada directamente. En su lugar, accede al singleton usando :ref:`EditorInterface.get_script_editor<class_EditorInterface_method_get_script_editor>`.
...
Emitido cuando el usuario cambió el script activo. El argumento es un :ref:`Script<class_Script>` recién activado.
...
Emitido cuando el editor está a punto de cerrar el script activo. El argumento es un :ref:`Script<class_Script>` que va a ser cerrado.
