...
Si ``true``, calcula las sombras en la sonda de reflexión. Esto hace que la sonda de reflexión se renderice más lentamente; puede que quieras desactivarlo si utilizas el :ref:`UPDATE_ALWAYS<class_ReflectionProbe_constant_UPDATE_ALWAYS>` :ref:`update_mode<class_ReflectionProbe_property_update_mode>`.
