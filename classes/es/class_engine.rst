...
Proporciona acceso a las propiedades del motor.
...
Devuelve el texto de la licencia completa de Godot.
...
Devuelve una instancia de un :ref:`ScriptLanguage<class_ScriptLanguage>` con el ``index`` dado.
...
Devuelve el número de idiomas de script disponibles. Se usa con :ref:`get_script_language()<class_Engine_method_get_script_language>`.
...
Devuelve una lista de nombres de todos los singleton globales disponibles. Véase también :ref:`get_singleton()<class_Engine_method_get_singleton>`.
