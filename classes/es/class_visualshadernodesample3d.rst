...
Un nodo base para los nodos que muestrean texturas 3D en el gráfico de shader visual.
...
Representa el tamaño del enum :ref:`Source<enum_VisualShaderNodeSample3D_Source>`.
