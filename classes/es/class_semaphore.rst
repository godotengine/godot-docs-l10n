...
Un semáforo de sincronización.

Descripción
----------------------

Un semáforo de sincronización que puede utilizarse para sincronizar múltiples :ref:`Thread<class_Thread>`\ s. Inicializado a cero en la creación. Tenga cuidado para evitar los bloqueos. Para una versión binaria, véase :ref:`Mutex<class_Mutex>`.
