...
**Heredado por:** :ref:`PhysicalBone2D<class_PhysicalBone2D>`
...
- `Demo de Plataformas de Física en 2D <https://godotengine.org/asset-library/asset/2725>`__
...
\ **Nota:** Cambiar el valor :ref:`sleeping<class_RigidBody2D_property_sleeping>` no activará esta señal. Solo se emite si el motor de física cambia el estado de sueño o si se utiliza ``emit_signal("sleeping_state_changed")``.
...
Modo de congelación cinemática de cuerpos. Similar a :ref:`FREEZE_MODE_STATIC<class_RigidBody2D_constant_FREEZE_MODE_STATIC>`, pero colisiona con otros cuerpos en su trayectoria al moverse. Útil para cuerpos congelados que necesitan ser animados.
...
En este modo, el centro de masa del cuerpo se establece a través de :ref:`center_of_mass<class_RigidBody2D_property_center_of_mass>`. El valor predeterminado es la posición de origen del cuerpo.
...
Define cómo se aplica :ref:`angular_damp<class_RigidBody2D_property_angular_damp>`.
...
Esto es equivalente a usar :ref:`add_constant_force()<class_RigidBody2D_method_add_constant_force>` en el centro de masa del cuerpo.
...
Esto es equivalente a usar :ref:`apply_force()<class_RigidBody2D_method_apply_force>` en el centro de masa del cuerpo.
...
Esto es equivalente a usar :ref:`apply_impulse()<class_RigidBody2D_method_apply_impulse>` en el centro de masa del cuerpo.
...
\ **Nota:** Se requiere :ref:`inertia<class_RigidBody2D_property_inertia>` para que esto funcione. Para tener :ref:`inertia<class_RigidBody2D_property_inertia>`, un :ref:`CollisionShape2D<class_CollisionShape2D>` activo debe ser hijo del nodo, o puede establecer manualmente :ref:`inertia<class_RigidBody2D_property_inertia>`.
