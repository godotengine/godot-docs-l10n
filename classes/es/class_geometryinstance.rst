...
- **FLAG_MAX** = **2** --- Representa el tamaño del enum :ref:`Flags<enum_GeometryInstance_Flags>`.
...
El flag de sombra seleccionada. Ver :ref:`ShadowCastingSetting<enum_GeometryInstance_ShadowCastingSetting>` para los posibles valores.
...
Anula el cuadro delimitador de este nodo con uno personalizado. Para eliminarlo, establece un :ref:`AABB<class_AABB>` con todos los campos puestos a cero.
