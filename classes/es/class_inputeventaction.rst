...
Tipo de evento de entrada para las acciones.

Descripción
----------------------

Contiene una acción genérica que puede ser dirigida desde varios tipos de entradas. Las acciones pueden crearse desde la pestaña **Mapa de entrada** del menú **Proyecto > Configuración del proyecto**. Ver :ref:`Node._input<class_Node_method__input>`.
...
El nombre de la acción. Se accede a las acciones a través de esta :ref:`String<class_String>`.
...
Si ``true``, se presiona el estado de la acción. Si ``false``, se libera el estado de la acción.
