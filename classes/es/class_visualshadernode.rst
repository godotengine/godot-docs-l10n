...
Tipo Sampler. Traducido a referencia de la variable uniforme del muestras en el código de shader. Solo puede utilizarse para puertos de entrada en nodos no uniformes.
