...
Base abstracta :ref:`Resource<class_Resource>` para colorear y sombrear la geometría.
...
- **RENDER_PRIORITY_MAX** = **127** --- Valor máximo del parámetro :ref:`render_priority<class_Material_property_render_priority>`.

- **RENDER_PRIORITY_MIN** = **-128** --- Valor mínimo del parámetro :ref:`render_priority<class_Material_property_render_priority>`.
