...
Cabecera de configuración para marcadores de código QR micro.
...
Cabecera de configuración para marcadores de código QR micro. Pasa esto a :ref:`OpenXRSpatialEntityExtension.create_spatial_context()<class_OpenXRSpatialEntityExtension_method_create_spatial_context>` para crear un contexto espacial que pueda detectar marcadores de código QR micro.
