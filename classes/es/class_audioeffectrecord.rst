...
A diferencia de :ref:`AudioEffectCapture<class_AudioEffectCapture>`, este efecto codifica la grabación en el formato especificado (8-bit, 16-bit o comprimido) en lugar de proporcionar acceso a las muestras de sonido sin procesar.
