...
Clase de extensión :ref:`GLTFDocument<class_GLTFDocument>`.
...
Parte del proceso de importación. Este método se ejecuta al final, después de todas las demás partes del proceso de importación.

Este método puede utilizarse para modificar la escena final de Godot generada por el proceso de importación.
...
Parte del proceso de importación. Este método se ejecuta después de :ref:`_parse_node_extensions()<class_GLTFDocumentExtension_private_method__parse_node_extensions>` y antes de :ref:`_import_pre_generate()<class_GLTFDocumentExtension_private_method__import_pre_generate>`.

Este método puede utilizarse para modificar cualquiera de los datos importados hasta el momento después de analizar cada nodo, pero antes de generar la escena o cualquiera de sus nodos.
...
Parte del proceso de importación. Este método se ejecuta después de :ref:`_import_post_parse()<class_GLTFDocumentExtension_private_method__import_post_parse>` y antes de :ref:`_generate_scene_node()<class_GLTFDocumentExtension_private_method__generate_scene_node>`.

Este método puede utilizarse para modificar o leer cualquiera de las estructuras de datos procesadas, antes de generar los nodos y ejecutar el paso final de importación por nodo.
...
Parte del proceso de importación. Este método se ejecuta en primer lugar, antes de todas las demás partes del proceso de importación.

El valor de retorno se utiliza para determinar si esta instancia de **GLTFDocumentExtension** debe utilizarse para importar un archivo glTF determinado. Si se devuelve :ref:`@GlobalScope.OK<class_@GlobalScope_constant_OK>`, la importación utilizará esta instancia de **GLTFDocumentExtension**. Si no se sobrescribe, se devuelve :ref:`@GlobalScope.OK<class_@GlobalScope_constant_OK>`.
