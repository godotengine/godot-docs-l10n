...
Establece el tipo de puerto de entrada especificado (ver :ref:`PortType<enum_VisualShaderNode_PortType>`).
...
Define todos los puertos de entrada usando una :ref:`String<class_String>` formateada como una lista separada por dos puntos: ``id,type,name;`` (ver :ref:`add_input_port<class_VisualShaderNodeGroupBase_method_add_input_port>`).
...
Establece el tipo de puerto de salida especificado (ver :ref:`PortType<enum_VisualShaderNode_PortType>`).
...
Define todos los puertos de salida utilizando una :ref:`String<class_String>` formateada como una lista separada por dos puntos: ``id, type, name;`` (ver :ref:`add_output_port<class_VisualShaderNodeGroupBase_method_add_output_port>`).
