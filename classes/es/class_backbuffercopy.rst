...
El área cubierta por el **BackBufferCopy**. Solo se utiliza si :ref:`copy_mode<class_BackBufferCopy_property_copy_mode>` es :ref:`COPY_MODE_RECT<class_BackBufferCopy_constant_COPY_MODE_RECT>`.
