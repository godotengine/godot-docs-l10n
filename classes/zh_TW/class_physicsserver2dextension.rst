...
**繼承：** :ref:`PhysicsServer2D<class_PhysicsServer2D>` **<** :ref:`Object<class_Object>`

提供覆蓋後可以用來建立自訂 :ref:`PhysicsServer2D<class_PhysicsServer2D>` 實作的虛方法。
...
這個類擴充自 :ref:`PhysicsServer2D<class_PhysicsServer2D>`\ ，提供可額外的可覆蓋虛方法。覆蓋這些方法後，就不會呼叫物理伺服器內部方法，而是呼叫這些覆蓋後的方法。

旨在用於 GDExtension，用於建立自訂 :ref:`PhysicsServer2D<class_PhysicsServer2D>` 實作。
