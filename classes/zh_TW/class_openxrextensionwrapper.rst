...
**被繼承：** :ref:`OpenXRExtensionWrapperExtension<class_OpenXRExtensionWrapperExtension>`, :ref:`OpenXRFutureExtension<class_OpenXRFutureExtension>`, :ref:`OpenXRRenderModelExtension<class_OpenXRRenderModelExtension>`
...
傳回與此擴充相關的 OpenXR 擴充的 :ref:`Dictionary<class_Dictionary>`\ 。\ :ref:`Dictionary<class_Dictionary>` 應包含擴充的名稱，對應到 ``bool *``\ 轉換為整數：

- 如果 ``bool *`` 是 ``nullptr``\ ，則此擴充功能是強制性的。

- 如果\ ``bool *`` 指向布林值，則在啟用擴充的情況下，該布林值將更新為\ ``true``\ 。
