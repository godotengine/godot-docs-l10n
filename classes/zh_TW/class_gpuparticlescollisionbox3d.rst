...
Box-3D 粒子碰撞的形狀影響 :ref:`GPUParticles3D<class_GPUParticles3D>` 節點。
...
盒狀3D粒子碰撞形狀影響\ :ref:`GPUParticles3D<class_GPUParticles3D>`\ 節點。

\ **注意：**\ :ref:`ParticleProcessMaterial.collision_mode<class_ParticleProcessMaterial_property_collision_mode>`\ 必須是\ :ref:`ParticleProcessMaterial.COLLISION_RIGID<class_ParticleProcessMaterial_constant_COLLISION_RIGID>`\ 或\ :ref:`ParticleProcessMaterial.COLLISION_HIDE_ON_CONTACT<class_ParticleProcessMaterial_constant_COLLISION_HIDE_ON_CONTACT>`\ 在經過\ :ref:`GPUParticles3D<class_GPUParticles3D>`\ 的材質上，碰撞才能發揮作用。

\ **注意：**\ 粒子碰撞只影響到\ :ref:`GPUParticles3D<class_GPUParticles3D>`\ ，而不是\ :ref:`CPUParticles3D<class_CPUParticles3D>`\ 。
