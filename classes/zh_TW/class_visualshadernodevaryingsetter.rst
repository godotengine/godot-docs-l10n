...
向著色器中定義的 varying 輸入一個值。你需要首先建立可用於該函式的 varying，例如 Fragment 著色器的 varying setter 需要模式為 :ref:`VisualShader.VARYING_MODE_FRAG_TO_LIGHT<class_VisualShader_constant_VARYING_MODE_FRAG_TO_LIGHT>` 的 varying。
