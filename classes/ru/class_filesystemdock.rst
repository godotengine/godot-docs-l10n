...
Вызывается при изменении выделения. Используйте :ref:`EditorInterface.get_selected_paths()<class_EditorInterface_method_get_selected_paths>` в подключенном методе, чтобы получить выделенные пути.
