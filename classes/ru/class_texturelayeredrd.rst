...
\ **Примечание:** **TextureLayeredRD** предназначен для низкоуровневого использования с :ref:`RenderingDevice<class_RenderingDevice>`. В большинстве случаев используйте :ref:`TextureLayered<class_TextureLayered>` вместо него.
