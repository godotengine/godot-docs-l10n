...
Переопределите этот метод, чтобы указать, следует ли гизмо-элементам фиксировать изменения, если конечное положение манипулятора совпадает с начальным. Возвращает ``false``, если метод не переопределён.
