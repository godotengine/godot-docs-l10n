...
\ **Примечание:** :ref:`custom_solver_bias<class_Shape3D_property_custom_solver_bias>` действует только при использовании GodotPhysics3D. Он не оказывает эффекта при использовании Jolt Physics.
