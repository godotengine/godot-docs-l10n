...
Этот метод работает быстрее, чем :ref:`distance_to()<class_Vector2_method_distance_to>`, поэтому предпочитайте его, если вам нужно сравнить векторы или вам нужен квадрат расстояния для какой-либо формулы.
