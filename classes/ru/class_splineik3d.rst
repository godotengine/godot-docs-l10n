...
:ref:`SkeletonModifier3D<class_SkeletonModifier3D>` для выравнивания костей вдоль :ref:`Path3D<class_Path3D>`. Плавность подгонки зависит от :ref:`Curve3D.bake_interval<class_Curve3D_property_bake_interval>`.
