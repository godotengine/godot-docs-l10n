...
Базовый класс для :ref:`SkeletonModifier3D<class_SkeletonModifier3D>`, который изменяет кость, заданную через :ref:`set_apply_bone()<class_BoneConstraint3D_method_set_apply_bone>`, на основе трансформации кости, полученной через :ref:`get_reference_bone()<class_BoneConstraint3D_method_get_reference_bone>`.
