...
Если ``true``, минимальный размер будет определяться шириной самого длинного элемента, а не текущего выбранного. Также будут учитываться поля всплывающего окна, чтобы кнопка соответствовала его общей ширине.

\ **Примечание:** По соображениям производительности минимальный размер не обновляется немедленно при добавлении, удалении или изменении элементов.
