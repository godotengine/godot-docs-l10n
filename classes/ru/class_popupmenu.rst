...
Используйте :ref:`search_bar_fuzzy_search_max_misses<class_PopupMenu_property_search_bar_fuzzy_search_max_misses>`, чтобы установить максимальное количество несовпадений, допустимых в результатах поиска.
