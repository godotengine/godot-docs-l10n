...
Если этот бит установлен, :ref:`update_image()<class_RichTextLabel_method_update_image>` изменяет ширину изображения с/на проценты.
...
Если ``true``, минимальный размер метки будет автоматически обновлен в соответствии с ее содержимым, соответствуя поведению :ref:`Label<class_Label>`.
