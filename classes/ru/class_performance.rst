...
Количество активных навигационных карт в :ref:`NavigationServer2D<class_NavigationServer2D>` и :ref:`NavigationServer3D<class_NavigationServer3D>`. Сюда также входят пустые навигационные карты по умолчанию, созданные экземплярами :ref:`World2D<class_World2D>` и :ref:`World3D<class_World3D>`.
...
Количество активных навигационных карт в :ref:`NavigationServer2D<class_NavigationServer2D>`. Сюда также входят пустые навигационные карты по умолчанию, созданные экземплярами :ref:`World2D<class_World2D>`.
...
Количество активных навигационных карт в :ref:`NavigationServer3D<class_NavigationServer3D>`. Сюда также входят пустые навигационные карты по умолчанию, созданные экземплярами :ref:`World3D<class_World3D>`.
...
Возвращает значения :ref:`MonitorType<enum_Performance_MonitorType>` активных пользовательских мониторов в :ref:`Array<class_Array>`.
