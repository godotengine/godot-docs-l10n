...
Плоскость выровнена вертикально.
...
Плоскость имеет произвольное выравнивание.
...
Возвращает выравнивание плоскости для родительского объекта по этому ``index``.
