...
Фильтр нижних частот ослабляет частоты выше :ref:`AudioEffectFilter.cutoff_hz<class_AudioEffectFilter_property_cutoff_hz>` и пропускает более низкие частоты без изменений.
