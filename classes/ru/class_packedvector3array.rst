...
Массив, специально разработанный для хранения :ref:`Vector3<class_Vector3>`. Плотно упаковывает данные, поэтому экономит память для больших размеров массива.
