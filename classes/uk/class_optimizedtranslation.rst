...
Створює та встановлює оптимізований переклад із вказаного ресурсу :ref:`Translation<class_Translation>`. У разі успіху повертає ``true``.

\ **Примітка:** Повідомлення в ``from`` не повинні містити контекстні або множинні форми.

\ **Примітка:** Цей метод призначений для використання в редакторі. Він не виконує жодних дій при виклику з експортованого проєкту.
