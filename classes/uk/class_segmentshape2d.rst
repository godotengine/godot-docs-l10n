...
Форма сегмента 2D використовується для фізичного зіткнення.
...
Форма сегмента 2D, призначена для використання в фізиці. Зазвичай використовується для забезпечення форми для :ref:`CollisionShape2D<class_CollisionShape2D>`.
