...
Затискає значення в графі візуального відтінку.
...
Накопичуйте значення, щоб лежати між ``min`` і ``max`` значення.
...
Представляємо розмір :ref:`OpType<enum_VisualShaderNodeClamp_OpType>` enum.
