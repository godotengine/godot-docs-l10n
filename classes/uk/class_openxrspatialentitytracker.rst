...
Видається при зміні наступного ланцюга в результаті виклику або методу :ref:`add_next()<class_OpenXRSpatialEntityTracker_method_add_next>`, або методу :ref:`remove_next()<class_OpenXRSpatialEntityTracker_method_remove_next>`.
...
Додає новий об’єкт :ref:`OpenXRStructureBase<class_OpenXRStructureBase>` до наступного ланцюга.

Метод :ref:`get_next()<class_OpenXRSpatialEntityTracker_method_get_next>` повертатиме цей ``next`` доти, доки не буде знову викликано метод :ref:`add_next()<class_OpenXRSpatialEntityTracker_method_add_next>` або його не буде видалено за допомогою методу :ref:`remove_next()<class_OpenXRSpatialEntityTracker_method_remove_next>`.
...
Отримує головний елемент :ref:`OpenXRStructureBase<class_OpenXRStructureBase>` у наступному ланцюжку.

Див. також :ref:`add_next()<class_OpenXRSpatialEntityTracker_method_add_next>` та :ref:`remove_next()<class_OpenXRSpatialEntityTracker_method_remove_next>`.
...
Отримує просторовий контекст, який використовувався для створення цього **OpenXRSpatialEntityTracker**.
...
Видаляє об’єкт ``next``, раніше доданий у :ref:`add_next()<class_OpenXRSpatialEntityTracker_method_add_next>`, із ланцюжка наступних елементів.
...
Встановлює просторовий контекст, який використовується для створення цього трекера.
