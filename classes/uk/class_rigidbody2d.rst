...
Див. :ref:`freeze_mode<class_RigidBody2D_property_freeze_mode>`, щоб встановити поведінку тіла під час заморожування.

\ **Примітка:** Для тіла, яке завжди заморожене, використовуйте :ref:`StaticBody2D<class_StaticBody2D>` або :ref:`AnimatableBody2D<class_AnimatableBody2D>`.
...
Режим заморожування тіла. Визначає поведінку тіла, коли :ref:`freeze<class_RigidBody2D_property_freeze>` має значення ``true``.
