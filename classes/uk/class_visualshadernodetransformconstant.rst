...
Постійна робота :ref:`Transform3D<class_Transform3D>` для використання в графі візуального відтінку.
...
Постійна :ref:`Transform3D<class_Transform3D>`, яка може використовуватися як вхідний вузол.
...
Постійна :ref:`Transform3D<class_Transform3D>`, яка представляє стан даного вузла.
