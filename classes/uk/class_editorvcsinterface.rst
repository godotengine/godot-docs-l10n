...
Повертає значення, яке вказує, чи дозволяє плагін вносити зміни до коміту.
...
Зберігає зміни, що наразі знаходяться у стадії підготовки, та застосовує запис ``msg`` до отриманого запису. Якщо ``amend`` має значення ``true``, запис буде змінено замість цього.
