...
Повертає відстань між двома точками. Щоб використовуватися в графі візуального відтінку.
...
Розрахунок відстані від точки, представленої вектором ``p0`` до вектора ``p1``.

Перекладено як ``distance(p0, p1)`` мовою shar.
