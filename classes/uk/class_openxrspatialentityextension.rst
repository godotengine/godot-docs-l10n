...
Зручний метод, коли у виклику є лише :ref:`Array<class_Array>` у :ref:`OpenXRSpatialComponentData<class_OpenXRSpatialComponentData>` і потрібно виявити просторові об’єкти.
