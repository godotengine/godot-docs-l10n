...
Якщо ``true``, генерувати тангенси вершин за допомогою `Mikktspace <http://www.mikktspace.com/>`__, якщо вихідна сітка не містить даних про тангенси. Якщо це можливо, рекомендується дозволити програмі 3D-моделювання генерувати тангенси під час експорту, замість того щоб покладатися на цю опцію. Тангенти необхідні для коректного відображення карт нормалей та висот, а також будь-яких функцій матеріалів/шейдерів, що вимагають тангентів.
