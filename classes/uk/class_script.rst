...
Повертає ``true``, якщо скрипт або базовий клас визначає метод із вказаним іменем.
...
**Застаріло:** Compare this script with :ref:`Object.get_script()<class_Object_method_get_script>` instead.
