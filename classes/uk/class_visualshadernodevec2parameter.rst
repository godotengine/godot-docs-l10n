...
Параметри параметра :ref:`Vector2<class_Vector2>` для використання в графі візуального відтінку.
...
Перекладено як ``uniform vec2`` мовою shar.
...
Дозволяє використовувати :ref:`default_value<class_VisualShaderNodeVec2Parameter_property_default_value>`.
