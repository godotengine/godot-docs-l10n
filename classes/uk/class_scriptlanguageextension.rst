...
**Успадковує:** :ref:`ScriptLanguage<class_ScriptLanguage>` **<** :ref:`Object<class_Object>`
...
**Застаріло:** Ця константа може бути змінена або усунута у наступних версіях.
...
Повертає джерело, пов'язане з даним положенням стек.
...
Повертає рядок, де функція визначається в коді, або ``-1``, якщо функція не присутній.
...
Перезавантажує всі ``scripts`` з диска, а конкретні деталі цього процесу залежать від розширення **ScriptLanguageExtension**.
...
Перезавантажує вказаний ``script`` з диска, а конкретні деталі цього процесу залежать від розширення **ScriptLanguageExtension**.
