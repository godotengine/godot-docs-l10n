...
Встановлює очікувану ємність, визначену системою запитів до просторових об’єктів. Буфери слід ініціалізувати з урахуванням відповідного обсягу пам’яті.
...
Отримує ``XrSpatialComponentTypeEXT`` цього **OpenXRSpatialComponentData**.
