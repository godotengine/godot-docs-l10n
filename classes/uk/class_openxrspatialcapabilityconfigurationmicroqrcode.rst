...
Заголовок конфігурації для маркерів QR-кодів.
...
Заголовок конфігурації для маркерів QR-кодів. Передайте його до :ref:`OpenXRSpatialEntityExtension.create_spatial_context()<class_OpenXRSpatialEntityExtension_method_create_spatial_context>`, щоб створити просторовий контекст, який може виявляти маркери QR-кодів.
