...
Цей метод працює швидше, ніж :ref:`distance_to()<class_Vector2_method_distance_to>`, тому краще використовувати саме його, якщо вам потрібно порівняти вектори або обчислити квадрат відстані для якоїсь формули.
