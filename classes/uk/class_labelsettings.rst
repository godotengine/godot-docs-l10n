...
Колір контуру в позиції ``index``.

\ **Примітка:** ``index`` — це значення в діапазоні ``0 .. stacked_outline_count - 1``.
...
Колір тіні за ``індекс``.

\ **Примітка:** ``індекс`` — це значення в діапазоні ``0 .. stacked_shadow_count - 1``.
...
\ **Примітка:** ``index`` — це значення в діапазоні ``0 .. stacked_shadow_count - 1``.
