...
Додає додаткові структури даних до ``XrCompositionLayerProjection``.

Цей метод буде викликано лише в тому випадку, якщо розширення попередньо зареєструвалося за допомогою :ref:`OpenXRAPIExtension.register_projection_layer_extension()<class_OpenXRAPIExtension_method_register_projection_layer_extension>`.
