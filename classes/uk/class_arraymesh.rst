...
Оновлює буфер атрибутів поверхні цієї сітки за допомогою вказаних ``data``. Очікуваний обсяг даних на атрибут становить 12 або 8 байтів (4 байти на float, 2 float на :ref:`Vector2<class_Vector2>` та 3 float на :ref:`Vector3<class_Vector3>`), залежно від того, чи використовує сітка вершини :ref:`Vector3<class_Vector3>` чи :ref:`Vector2<class_Vector2>`. Це значення можна визначити за допомогою :ref:`RenderingServer.mesh_surface_get_format_attribute_stride()<class_RenderingServer_method_mesh_surface_get_format_attribute_stride>`.

Початкову точку оновлень можна змінити за допомогою ``offset``. Значення ``offset`` у більшості випадків має бути кратним 12 байтам, щоб вирівняти кожен атрибут.

\ :ref:`PackedVector3Array<class_PackedVector3Array>` з розташуваннями атрибутів можна перетворити на :ref:`PackedByteArray<class_PackedByteArray>` за допомогою :ref:`PackedVector3Array.to_byte_array()<class_PackedVector3Array_method_to_byte_array>` для використання в ``data``.
...
Оновлює буфер текстури поверхні цієї сітки за допомогою вказаних ``data``. Очікуваний обсяг даних на кожну скін становить 12 або 8 байтів (4 байти на float, 2 float на :ref:`Vector2<class_Vector2>` та 3 float на :ref:`Vector3<class_Vector3>`), залежно від того, чи використовує сітка вершини :ref:`Vector3<class_Vector3>` чи :ref:`Vector2<class_Vector2>`. Це значення можна визначити за допомогою :ref:`RenderingServer.mesh_surface_get_format_skin_stride()<class_RenderingServer_method_mesh_surface_get_format_skin_stride>`.

Початкову точку оновлень можна змінити за допомогою ``offset``. Значення ``offset`` у більшості випадків має бути кратним 12 байтам, щоб вирівняти кожну скін.

\ :ref:`PackedVector3Array<class_PackedVector3Array>` з розташуваннями скінів можна перетворити на :ref:`PackedByteArray<class_PackedByteArray>` за допомогою :ref:`PackedVector3Array.to_byte_array()<class_PackedVector3Array_method_to_byte_array>` для використання в ``data``.
...
Оновлює буфер вершин поверхні цієї сітки за допомогою вказаних ``data``. Очікуваний обсяг даних на вершину становить 12 або 8 байтів (4 байти на float, 2 float на :ref:`Vector2<class_Vector2>` та 3 float на :ref:`Vector3<class_Vector3>`), залежно від того, чи використовує сітка вершини :ref:`Vector3<class_Vector3>` чи :ref:`Vector2<class_Vector2>`. Це значення можна визначити за допомогою :ref:`RenderingServer.mesh_surface_get_format_vertex_stride()<class_RenderingServer_method_mesh_surface_get_format_vertex_stride>`.

Початкову точку оновлень можна змінити за допомогою ``offset``. Значення ``offset`` у більшості випадків має бути кратним 12 байтам, щоб вирівняти кожну вершину.

\ :ref:`PackedVector3Array<class_PackedVector3Array>` з координатами вершин можна перетворити на :ref:`PackedByteArray<class_PackedByteArray>` за допомогою :ref:`PackedVector3Array.to_byte_array()<class_PackedVector3Array_method_to_byte_array>` для використання в ``data``.
