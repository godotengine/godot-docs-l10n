...
:ref:`Vector3<class_Vector3>` постійно використовується в графі візуального відтінку.
...
Постійна :ref:`Vector3<class_Vector3>`, яка може використовуватися як вхідний вузол.
...
А :ref:`Vector3<class_Vector3>` постійний, що представляє стан даного вузла.
