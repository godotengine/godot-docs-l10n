...
Функція «Субвідправник» вимкнена.
...
Сигнал випромінюється з постійною періодичністю, визначеною параметром :ref:`sub_emitter_frequency<class_ParticleProcessMaterial_property_sub_emitter_frequency>`.
...
Субеммітер випромінюється наприкінці терміну існування частинки.
...
Підсигнал генерується під час зіткнення частинки.
...
Субеммітер випромінюється під час появи частинки.
...
Якщо ``true``, частинки успадковуватимуть масштаб емітера.

\ **Примітка:** Це не впливає на результат, якщо :ref:`GPUParticles3D.local_coords<class_GPUParticles3D_property_local_coords>` має значення ``true``, оскільки на частинки в локальному просторі вже впливає масштаб емітера.
...
Максимальний кут повороту в 3D, у градусах. Працює лише в режимі 3D і за умови, що параметр :ref:`use_rotation_3d<class_ParticleProcessMaterial_property_use_rotation_3d>` увімкнено.
...
Мінімальний кут орієнтації в 3D, у градусах. Працює лише в 3D і за умови, що параметр :ref:`use_rotation_3d<class_ParticleProcessMaterial_property_use_rotation_3d>` увімкнено.
...
Крива швидкості обертання протягом терміну експлуатації для кожної осі. Щоб скористатися цією функцією, увімкніть параметр :ref:`use_rotation_velocity_3d<class_ParticleProcessMaterial_property_use_rotation_velocity_3d>`.
...
Максимальна швидкість обертання у 3D-просторі навколо локальної осі частинки. Щоб скористатися цією функцією, увімкніть параметр :ref:`use_rotation_velocity_3d<class_ParticleProcessMaterial_property_use_rotation_velocity_3d>`.
...
Мінімальна швидкість обертання у 3D-просторі навколо локальної осі частинки. Щоб скористатися цією функцією, увімкніть параметр :ref:`use_rotation_velocity_3d<class_ParticleProcessMaterial_property_use_rotation_velocity_3d>`.
...
Максимальне значення вектора випадкового масштабування для кожної частинки.

Працює лише за умови, що ввімкнено параметр :ref:`use_scale_3d<class_ParticleProcessMaterial_property_use_scale_3d>`.
...
Мінімальне значення вектора випадкового масштабування для кожної частинки.
...
Увімкніть використання параметрів :ref:`rotation_3d_min<class_ParticleProcessMaterial_property_rotation_3d_min>` та :ref:`rotation_3d_max<class_ParticleProcessMaterial_property_rotation_3d_max>`.
...
Увімкнути швидкість обертання в 3D.
...
Увімкнути використання параметрів :ref:`scale_3d_min<class_ParticleProcessMaterial_property_scale_3d_min>` та :ref:`scale_3d_max<class_ParticleProcessMaterial_property_scale_3d_max>`.
