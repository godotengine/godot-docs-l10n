...
У графі візуального відтінку не позначений скаляр цілої константи.
...
Перекладено як ``uint`` мовою шейдерів.
...
Невизначена ціла константа, яка представляє стан цього вузла.
