...
Надає параметри для :ref:`PhysicsServer3D.body_test_motion()<class_PhysicsServer3D_method_body_test_motion>`.
...
Змінюючи різні властивості цього об'єкта, такі як рух, можна налаштувати параметри для :ref:`PhysicsServer3D.body_test_motion()<class_PhysicsServer3D_method_body_test_motion>`.
...
Якщо встановити до ``true``, форми типу :ref:`PhysServer3D. SHAPE_SEPARATION_RAY<class_PhysServer3D_constant_ SHAPE_SEPARATION_RAY>` використовується для виявлення зіткнень і може зупинити рух. Може бути корисною при попаданні на землю.

Якщо встановити до ``false``, форми типу :ref:`PhysServer3D. SHAPE_SEPARATION_RAY<class_PhysServer3D_constant_ SHAPE_SEPARATION_RAY>` використовується для поділу при перекриттях з іншими тілами. Це основне використання для поділу променевих форм.
...
Необов'язковий масив елементів body :ref:`RID<class_RID>` для виключення з колізії. Використовуйте метод :ref:`CollisionObject3D.get_rid()<class_CollisionObject3D_method_get_rid>`, щоб отримати :ref:`RID<class_RID>`, пов'язаний з вузлом, похідним від :ref:`CollisionObject3D<class_CollisionObject3D>`.
...
Трансформація в глобальному просторі, де рух повинен початися. Зазвичай набір до :ref:`Node3D.global_transform<class_Node3D_property_global_transform>` для перетворення поточного тіла.
...
Максимальна кількість поновлюваних зіткнень, між ``1`` та ``32``. Завжди повертає найглибші виявлені зіткнення.
...
Якщо встановити до ``true``, будь-яке депенетування з фази відновлення повідомляється як зіткнення; це використовується наприклад :ref:`CharacterBody3D<class_CharacterBody3D>` для поліпшення виявлення підлоги під час перекриття підлоги.
