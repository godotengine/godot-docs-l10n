...
Візуальна шейдерна вершина, яка робить частинки, які випромінюються у формі коробки.
...
:ref:`VisualShaderNodeParticleEmitter<class_VisualShaderNodeParticleEmitter>`, що робить частинки, які випромінюються у формі коробки з вказаними розмірами.
