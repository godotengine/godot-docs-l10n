...
Вектор 4D постійно використовується в графі візуального відтінку.
...
Постійний 4D вектор, який може використовуватися як вхідний вузол.
...
Вектор 4D (представлений як :ref:`Quaternion<class_Quaternion>`) постійний, що являє собою стан даного вузла.
