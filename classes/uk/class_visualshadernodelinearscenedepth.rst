...
Візуальна шейдерна вершина, яка повертає значення глибини вузла DEPTH_TEXTURE в лінійному просторі.
...
Цей вузол можна використовувати в фрагментних шейдерах.
