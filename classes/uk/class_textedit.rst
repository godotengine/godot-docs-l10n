...
Якщо ``true``, **TextEdit** підлаштовує свою мінімальну висоту під кількість видимих рядків замість вертикального прокручування. Якщо встановлено максимальну висоту (наприклад, за допомогою :ref:`Control.custom_maximum_size<class_Control_property_custom_maximum_size>`) і вміст її перевищує, відображається вертикальна смуга прокрутки.
...
Якщо ``true``, **TextEdit** підлаштовує свою мінімальну ширину під найширший рядок замість горизонтального прокручування. Якщо встановлено максимальну ширину (наприклад, за допомогою :ref:`Control.custom_maximum_size<class_Control_property_custom_maximum_size>`) і вміст її перевищує, відображається горизонтальна смуга прокрутки.
...
Повертає ``true``, якщо курсор видимий, і ``false`` в іншому випадку. Курсор вважається прихованим, якщо він знаходиться за межами області прокрутки, коли прокрутка увімкнена.

\ **Примітка:** :ref:`is_caret_visible()<class_TextEdit_method_is_caret_visible>` не враховує, що курсор може бути поза екраном, якщо він все ще знаходиться в межах області прокрутки. Він поверне ``true``, навіть якщо курсор знаходиться поза екраном, якщо він відповідає власним умовам **TextEdit** щодо видимості. Сюди входить використання :ref:`scroll_fit_content_width<class_TextEdit_property_scroll_fit_content_width>` та :ref:`scroll_fit_content_height<class_TextEdit_property_scroll_fit_content_height>`, що змушують **TextEdit** розширюватися за межі області перегляду.

\ **Примітка:** Цей метод *не* гарантує точну перевірку видимості одразу після встановлення позиції курсора. Правильне значення може бути доступним лише в наступному кадрі після завершення малювання **TextEdit**. Це також стосується будь-якої операції, яка призводить до зміни розміру **TextEdit**.
...
Повертає ``true``, якщо вказаний рядок знаходиться в межах області прокрутки вікна перегляду.
