...
RemoteTransform2D відштовхує власну :ref:`Transform2D<class_Transform2D>` на іншу :ref:`Node2D<class_Node2D>` отриману вершину на сцені.
...
RemoteTransform2D відштовхує свій власний :ref:`Transform2D<class_Transform2D>` на інший :ref:`Node2D<class_Node2D>` отриманий вузол (званий віддалений вузол) на сцені.

Можна встановити для оновлення положення іншого вузла, обертання та/або ваги. Це може використовувати як глобальні, так і локальні координати.
...
:ref:`NodePath<class_NodePath>` до пульта дистанційного керування, відносно позиції RemoteTransform2D у сцені.
...
**RemoteTransform2D** кешує віддалений вузол. Він може не помітити, якщо віддалений вузол зникне; :ref:`force_update_cache()<class_RemoteTransform2D_method_force_update_cache>` змушує його знову оновлювати кеш.
