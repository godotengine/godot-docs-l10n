...
Скальмар, що плаваюча точка, буде використовуватися в графі візуального відтінку.
...
Перекладений на ``код пропустити-лінт``\ float[/code] в мові тіні.
...
Постійна плаваюча точка, яка являє собою стан цього вузла.
