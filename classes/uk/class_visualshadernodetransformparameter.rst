...
А параметр :ref:`Transform3D<class_Transform3D>` для використання в графі візуального відтінку.
...
Translated to ``uniform mat4`` in the shar language.
...
Дозволяє використовувати :ref:`default_value<class_VisualShaderNodeTransformParameter_property_default_value>`.
