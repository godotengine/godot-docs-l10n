...
Параметри параметра :ref:`Color<class_Color>` для використання в графі візуального відтінку.
...
Перекладено як ``uniform vec4`` мовою shar.
...
Дозволяє використовувати :ref:`default_value<class_VisualShaderNodeColorParameter_property_default_value>`.
