...
Повертає :ref:`String<class_String>` за заданим ``index`` у масиві. Якщо ``index`` виходить за межі або є від'ємним, цей метод завершується невдачею та повертає порожній рядок.
