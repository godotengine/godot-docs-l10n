...
Бололеан параметр для використання в графі візуального відтінку.
...
Перекладено як ``uniform bool`` мовою shar.
...
Дозволяє використовувати :ref:`default_value<class_VisualShaderNodeBooleanParameter_property_default_value>`.
