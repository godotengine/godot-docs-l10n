...
Встановлює курсор файлу у вказану позицію в байтах, від кінця файлу. Це змінює значення, що повертається методом :ref:`get_position()<class_FileAccess_method_get_position>`.

\ **Примітка:** Це зміщення, тому слід використовувати від'ємні числа, інакше курсор файлу буде в кінці файлу.
