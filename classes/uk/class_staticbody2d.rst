...
**Успадковано від:** :ref:`AnimatableBody2D<class_AnimatableBody2D>`

Фізичний корпус 2D, який не може переміщатися зовнішніми силами. При перенесенні вручну не впливає на інші тіла в його шляху.
...
Статичне двовимірне фізичне тіло. Його не можна перемістити зовнішніми силами чи контактами, але його можна перемістити вручну іншими засобами, такими як код, :ref:`AnimationMixer<class_AnimationMixer>` (з :ref:`AnimationMixer.callback_mode_process<class_AnimationMixer_property_callback_mode_process>`, встановленим на :ref:`AnimationMixer.ANIMATION_CALLBACK_MODE_PROCESS_PHYSICS<class_AnimationMixer_constant_ANIMATION_CALLBACK_MODE_PROCESS_PHYSICS>`), та :ref:`RemoteTransform2D<class_RemoteTransform2D>`.

Коли **StaticBody2D** переміщується, він телепортується в нове положення, не впливаючи на інші фізичні тіла на своєму шляху. Якщо це небажано, використовуйте замість цього :ref:`AnimatableBody2D<class_AnimatableBody2D>`.

\ **StaticBody2D** корисний для повністю статичних об'єктів, таких як підлоги та стіни, а також рухомих поверхонь, таких як конвеєрні стрічки та кругові обертові платформи (за допомогою :ref:`constant_linear_velocity<class_StaticBody2D_property_constant_linear_velocity>` та :ref:`constant_angular_velocity<class_StaticBody2D_property_constant_angular_velocity>`).
