...
Надає параметри для :ref:`PhysicsDirectSpaceState3D.intersect_point()<class_PhysicsDirectSpaceState3D_method_intersect_point>`.
...
При зміні різних властивостей цього об'єкта, таких як позиція точки, ви можете налаштувати параметри для :ref:`PhysicsDirectSpaceState3D.intersect_point()<class_PhysicsDirectSpaceState3D_method_intersect_point>`.
