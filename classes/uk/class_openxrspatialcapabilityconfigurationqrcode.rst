...
Заголовок конфігурації для мікромаркерів QR-кодів.
...
Заголовок конфігурації для мікромаркерів QR-кодів. Передайте його до :ref:`OpenXRSpatialEntityExtension.create_spatial_context()<class_OpenXRSpatialEntityExtension_method_create_spatial_context>`, щоб створити просторовий контекст, який може виявляти мікромаркери QR-кодів.
