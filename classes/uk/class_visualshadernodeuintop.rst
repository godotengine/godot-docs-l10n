...
У графі візуального відтінку не відзначається цілий оператор Scalar.
...
Застосовує :ref:`operator<class_VisualShaderNodeUIntOp_property_operator>` до двох беззнакових цілих вхідних даних: ``a`` і ``b``.
...
Представляємо розмір об’єкту :ref:`Operator<enum_VisualShaderNodeUIntOp_Operator>`.
