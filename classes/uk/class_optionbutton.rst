...
Якщо ``true``, мінімальний розмір визначатиметься за шириною найдовшого елемента, а не за шириною поточного вибраного елемента. При цьому також враховуватимуться поля спливаючого вікна, завдяки чому кнопка відповідатиме його загальній ширині.

\ **Примітка:** З міркувань продуктивності мінімальний розмір не оновлюється миттєво під час додавання, видалення або редагування елементів.
