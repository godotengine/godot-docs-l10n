...
Шар композиції OpenXR, який продається в якості внутрішнього зрізу циліндра.
...
Шар композиції OpenXR, що дозволяє надати :ref:`SubViewport<class_SubViewport>` на внутрішньому зрізі циліндра.
...
Співвідношення аспекту зрізу. Використовується для встановлення висоти відносно ширини.
...
Центральний кут циліндра. Використовується для встановлення ширини.
