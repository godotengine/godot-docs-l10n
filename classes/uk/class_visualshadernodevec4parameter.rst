...
Векторний параметр 4D для використання в графі візуального відтінку.
...
Дозволяє використовувати :ref:`default_value<class_VisualShaderNodeVec4Parameter_property_default_value>`.
