...
Повертає масив у заздалегідь визначеній палітрі кольорів за індексом ``index``. Палітра містить усі кольори, що використовуються для візуалізації символів шрифту. Кожна палітра має однакову кількість кольорів. Кольори можна замінити за допомогою методу :ref:`_font_set_palette_custom_colors()<class_TextServerExtension_private_method__font_set_palette_custom_colors>`.
