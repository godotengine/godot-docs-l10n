...
\ ``process_time`` визначає час, протягом якого частинки будуть оброблятися, коли випромінювання увімкнено. ``process_time_residual`` визначає час, протягом якого частинки будуть оброблятися, коли випромінювання вимкнено для симуляції. У поєднанні з :ref:`speed_scale<class_CPUParticles2D_property_speed_scale>`, встановленим на ``0.0``, це корисно для перемотування часової шкали системи частинок.
