...
Посилання на існуючу :ref:`VisualShaderNodeParameter<class_VisualShaderNodeParameter>`.
...
Створення посилання на :ref:`VisualShaderNodeParameter<class_VisualShaderNodeParameter>` дозволяє повторно використовувати цей параметр в різних шейдерах або шейдерах легко.
...
Назва параметра, в якому зазначені пункти.
